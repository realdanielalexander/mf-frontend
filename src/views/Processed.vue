        ...
        <div class="column is-four-fifths">
          <div class="card">
            <div class="card-content">
              <h1 class="title cart-header"><b>Processed</b></h1>
              <div></div>
              <div class="content" style="margin-bottom: 0">
                ...
                >
                  ...
                  <b-table-column field="action" label="Action" v-slot="props">
                      <b-button type="is-primary" @click="updateTransaction(props.row.id)">Ship Transaction</b-button>
                      <router-link
...
export default {
  ...
  methods: {
    ...
    filterTransactions() {
      const shipmentStatus = "Processed";
