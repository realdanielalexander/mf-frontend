        ...
        <div class="column is-four-fifths">
          <div class="card">
            <div class="card-content">
              <h1 class="title cart-header"><b>Shipped</b></h1>
              <div></div>
              <div class="content" style="margin-bottom: 0">
                ...
                >
                  ...
                  <b-table-column field="action" label="Action" v-slot="props">
                      <b-button type="is-primary" @click="updateTransaction(props.row.id)">Arrive Transaction</b-button>
                      <router-link
  ...
  methods: {
    ...
    async updateTransaction(transaction_id) {
      ...
      this.$buefy.dialog.alert({
        title: "Arrived Successful",
        message:
          "Product arrived successfully!",
        type: "is-success",
        hasIcon: true,
        icon: "check-circle",
        iconPack: "fa",
